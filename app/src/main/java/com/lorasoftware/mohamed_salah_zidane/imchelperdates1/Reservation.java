...
public class Reservation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctorListItem = (DoctorListItem)getIntent().getSerializableExtra("doctor");

          pName = (EditText)findViewById(R.id.nameEditTextd);
          pPhone = (EditText)findViewById(R.id.phoneNumEditTextd);
          pPlain = (EditText)findViewById(R.id.patiantPlaind);
            ...
            public void onClick(View view) {
                if (! pName.getText().toString().isEmpty() && ! pPhone.getText().toString().isEmpty()&& ! pPlain.getText().toString().isEmpty()){
                  ...
                  //  send.setBackground(R.drawable.buttonshape_afterpress);
                    ...
                    Toast.makeText(Reservation.this,"الرجاء التأكد من ادخال الاسم ورقم التليفون",Toast.LENGTH_LONG).show();
    ...
    private void jsonrequest() {
        ...
        Uri uri = new Uri.Builder()
                ...
                .path("/api/reserve/")
                .appendQueryParameter("id", doctorListItem.getDoctorTimesId()+"")
        ...
        String url = URLs.URL_RESRVE+"/"+doctorListItem.getDoctorId()
